...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GamePlayerBundle:Game')->findAll();
     ...
     * @Method("POST")
     * @Template("GamePlayerBundle:Game:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GamePlayerBundle:Game')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GamePlayerBundle:Game:edit.html.twig")
     */
